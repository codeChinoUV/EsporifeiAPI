...
from Servidor.app.manejo_de_archivos.controlador.MenejadorDePortadas import ManejadorDePortadas


class ValidacionPortadasService:

    @staticmethod
    def _validar_existe_album(id_album):
        """
    ...
    @staticmethod
    def _validar_existe_portada_usuario(id_usuario, calidad):
        """
    ...
    @staticmethod
    def _validar_existe_portada_creador_de_contenido(id_creador_de_contenido, calidad):
        """
    ...
    @staticmethod
    def _validar_existe_portada_album(id_album, calidad):
        """
    ...
    @staticmethod
    def _validar_tiene_creador_de_contenido(usuario):
        """
    ...
    @staticmethod
    def validar_subir_portada_usuario(token):
        """
    ...
    @staticmethod
    def validar_subir_portada_creador_de_contenido(token):
        """
        ...
        error_no_tiene_creador = ValidacionPortadasService._validar_tiene_creador_de_contenido(usuario)
        if error_no_tiene_creador is not None:
            return error_no_tiene_creador

    @staticmethod
    def validar_subir_portada_album(token, id_album):
        """
        ...
        if error_solo_creador_de_contenido is not None:
            return error_solo_creador_de_contenido
        error_no_existe_album = ValidacionPortadasService._validar_existe_album(id_album)
        if error_no_existe_album is not None:
            return error_no_existe_album
        error_no_es_dueno = ValidacionPortadasService._validar_es_dueno_de_album(token, id_album)
        if error_no_es_dueno is not None:
            return error_no_es_dueno

    @staticmethod
    def obtener_portada_usuario(token, id_usuario, calidad):
        """
        ...
        if error_token_invalido is not None:
            return error_token_invalido
        error_no_existe_portada = ValidacionPortadasService._validar_existe_portada_usuario(id_usuario, calidad)
        if error_no_existe_portada is not None:
            return error_no_existe_portada

    @staticmethod
    def obtener_portada_creador_de_contenido(token, id_creador_de_contenido, calidad):
        """
        ...
        error_no_existe_portada = ValidacionPortadasService. \
            _validar_existe_portada_creador_de_contenido(id_creador_de_contenido, calidad)
        if error_no_existe_portada is not None:
            return error_no_existe_portada

    @staticmethod
    def obtener_portada_album(token, id_album, calidad):
        """
        ...
        if error_no_existe_album is not None:
            return error_no_existe_album
        error_no_existe_portada = ValidacionPortadasService._validar_existe_portada_album(id_album, calidad)
        if error_no_existe_portada is not None:
            return error_no_existe_portada
